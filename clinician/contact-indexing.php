...
if (isset($_POST['submit'])) {
  ...
  $sql =  pg_query($connect, "SELECT registry_number FROM patient WHERE registry_number = '$registryNumber'");
  if (pg_num_rows($sql) > 0) {
    $message .= '<div class="col-12 alert alert-danger text-center">Registry number already existed..!</div>';
    header("Refresh:2;");
  } else {
    ...
    $_SESSION['patientId'] = pg_fetch_assoc($sql)['patient_id'];
  }
}
...
if (isset($_POST['sendText'])) {
  ...
  $addContact = "INSERT INTO patient_info(patient_id, code, phone)
                   VALUES('" . $_SESSION['patientId'] . "', '$code', '$mobile')";
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <div class="col-12 grid-margin">
            <div class="card">
              <div class="card-body">
                <form class="form-sample" method="POST" value="">
